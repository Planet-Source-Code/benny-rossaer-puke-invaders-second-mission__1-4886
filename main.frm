...
Begin VB.Form Level1 
   ...
   Begin VB.Label lbllevel1clear 
      ...
      Caption         =   "MISSION 1 ACCOMPLISHED"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   36
         Charset         =   0
...
MsgBox "Welcome to Puke Invaders - Second Mission." & vbCrLf & vbCrLf & "Keys: " & vbCrLf & "Space bar - shoot" & vbCrLf & "Arrow keys: move left/right" & vbCrLf & vbCrLf & "Congratiulations on defeating both previous enemies.  You did well.  But now, a new threat has appeared: the Killer Crabs!  They are faster, stronger and more powerful than anything you have faced before!  You must destroy them before they destroy you... and the galaxy!" & vbCrLf & "Have you collected the power-up in the previous mission?  If you haven't, then may God have mercy on your soul..." & vbCrLf & vbCrLf & "There might be another power-up hidden in this mission..." & vbCrLf & vbCrLf & "Good luck, soldier!", vbInformation, "Puke Invaders mission 2"
Level1.Hide
Level2.Show
...
If game = 1 Then
If KeyCode = vbKeyLeft Then Image1.Left = Image1.Left - 100: Image1.Picture = LoadPicture(App.Path & "\goleft.jpg")
If KeyCode = vbKeyRight Then Image1.Left = Image1.Left + 100: Image1.Picture = LoadPicture(App.Path & "\goright.jpg")
...
MsgBox "Welcome to Puke Invaders." & vbCrLf & vbCrLf & "Keys: " & vbCrLf & "Space bar - shoot" & vbCrLf & "Arrow keys: move left/right" & vbCrLf & vbCrLf & "Kill all the baddies!" & vbCrLf & "If you kill a baddie, you might get a power-up!" & vbCrLf & vbCrLf & "Be careful, you only have one life!  And mind the time-limit!  You must complete this first mission in 120 seconds or less!" & vbCrLf & vbCrLf & "Good luck, soldier!", vbInformation, "Puke Invaders mission 1"


game = 1
a = 0

Label1.Caption = "SHIP UPGRADED:" & vbCrLf & "YOU CAN NOW SHOOT TWICE AS FAST!!!"
